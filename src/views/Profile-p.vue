...
<!-- profile -->
    ...
    <section id="hero">
        <div class="container">
            ...
            <div class="right">
                <img src="../assets/Profile.jpg" alt="Pakorn">
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="all-items">
                <div class="item">
                    <div class="left">
                        <div class="img">
                            <img src="../assets/Profile.jpg" alt="project">
                        </div>
                    </div>
                    <div class="right">
                        ...
                        <div class="buttons">
                            ...
                            <a href="#" class="primary-btn-outline"><span>Preview</span><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
.section-heading::before {
    ...
    letter-spacing: 0.2rem;
    color: transparent;
    -webkit-text-stroke: 1.5px #2e5a7d;
    z-index: -1;
}
...
#projects .item .right .buttons .primary-btn-outline{
    ...
    justify-content: center;
    gap: 1rem;
    padding: calc(0.6em - 1.5px) calc(1.6em - 1.5px);
}

#projects .item .right .buttons .primary-btn-outline svg{
    width: 25px;
}
